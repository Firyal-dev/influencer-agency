<section class="z-50 fixed shadow-2xl w-full px-8 text-gray-300 bg-gray-900" {!! $attributes ?? '' !!}>
    <div class="font-[inter] container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl min-h-20">
        <div class="relative flex flex-col md:flex-row">
            ...
            <nav class="flex flex-wrap items-center mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-gray-700">
                <a href="{{ route('home') }}" class="mr-5 font-medium leading-6 {{ request()->routeIs('home') ? 'text-white' : 'text-gray-400 hover:text-white' }}">Beranda</a>
                <a href="#_" class="mr-5 font-medium leading-6 text-gray-400 hover:text-white">Tentang</a>
                <a href="{{ route('layanan') }}" class="mr-5 font-medium leading-6 {{ request()->routeIs('layanan') ? 'text-white' : 'text-gray-400 hover:text-white' }}">Layanan</a>
        ...
        <div class="inline-flex items-center ml-5 space-x-6 lg:justify-end">
            <a href="{{ route('login') }}" class="text-base font-medium leading-6 text-gray-400 whitespace-no-wrap transition duration-150 ease-in-out hover:text-white">
                Masuk
            </a>
